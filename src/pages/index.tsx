...
const Home: NextPage = () => {
  const { cookieMutation, theme } = useCookie()
  ...
  const badges = useMemo<TBadge[]>(() => {
    ...
    return [{
      ...
      alt: 'Firebase',
      id: randomId(),
      image: 'https://img.shields.io/badge/Firebase-039BE5?style=for-the-badge&logo=Firebase&logoColor=white'
    }]
  }, [])
      ...
      <main 
        ...
        <div className="fixed top-4 right-4">
          <button 
            ...
            { theme === 'dark'? <LightModeIcon className="text-white/80"/>: <DarkModeIcon className="text-black/80" />}
          </button>
        </div>
        <div className="container flex flex-col items-center justify-center gap-12 px-4 py-16 ">
          <h1 className={clsx('text-5xl', 'font-extrabold', 'tracking-tight', 'sm:text-[5rem]', {
            'text-white': theme === 'dark',
          ...
          <div className="grid grid-cols-1 gap-4 md:gap-8">
            <Link
              className={clsx('flex', 'max-w-md','flex-col','gap-4','rounded-xl', 'p-4', {
                'bg-white/10': theme === 'dark',
                'text-white': theme === 'dark',
                'hover:bg-white/20': theme === 'dark',
                'bg-black/10': theme === 'light',
            ...
            >
              ...
              <div className="inline-flex justify-center text-center gap-2">
                <Badges
                  badges={badges}
                />
              </div>
